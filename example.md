...
This script guides you through the process of transforming a rough idea into a detailed design document with an implementation plan and task list. It follows the Prompt-Driven Development methodology to systematically refine your idea, conduct necessary research, create a comprehensive design, and develop an actionable implementation plan in alignment with spec-driven development. The process is designed to be iterative, allowing movement between requirements clarification and research as needed.
...
- You MUST create the following files:
  ...
  - {project_dir}/idea-refinement.md (for requirements clarification)
...
**Constraints:**
- You MUST create an empty {project_dir}/idea-refinement.md file if it doesn't already exist
...
- You MUST NOT write multiple questions and answers to the idea-refinement.md file at once because this skips the interactive clarification process
- You MUST follow this exact process for each question:
  1. Formulate a single question
  2. Append the question to {project_dir}/idea-refinement.md
  ...
  5. Once you have their complete response, append the user's answer (or final decision) to {project_dir}/idea-refinement.md
...
- You MUST format the idea-refinement.md document with clear question and answer sections
...
### 8.1. Add Checkpoint Instructions 
Add checkpoint instructions to the implementation plan. The checkpointing type is "notes-only"
...
I notice you have several additional MCP search tools available beyond the standard ones, including 'web search' and other external search capabilities. Should I incorporate these additional search tools into the research process for broader coverage of template management solutions and industry best practices?
...
- docs/template-feature/
  ...
  - idea-refinement.md (our Q&A requirements clarification)
  - research/
